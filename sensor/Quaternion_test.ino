...
void computeDistance(float a, float delta, float degree){
  ...
  float a_corr = a-sin(degree*PI/180)*9.81+0.01;
  ...
  Serial.print("Deg: "); Serial.print(sin(degree*PI/180)*9.81);   Serial.print(" ");
  Serial.print("a_corr: "); Serial.print(a_corr);   Serial.print(" ");
...
void filter(vector_t acc, vector_t gyr) {
    ...
    angleX += (gyr.x / GYROSCOPE_SENSITIVITY) * dt/1000000.0f; // Angle around the X-axis
    angleY += (gyr.y / GYROSCOPE_SENSITIVITY) * dt/1000000.0f; // Angle around the Y-axis
    //angleZ += (gyr.z / GYROSCOPE_SENSITIVITY) * dt/1000000.0f; // Angle around the Z-axis
    ...
    if (forceMagnitudeApprox > 4 && forceMagnitudeApprox < 64)
    {
        ...
        void MadgwickQuaternionUpdate(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz)
        {
            ...
            q1 += qDot1 * dt/1000000.0f;
            q2 += qDot2 * dt/1000000.0f;
            q3 += qDot3 * dt/1000000.0f;
            q4 += qDot4 * dt/1000000.0f;
...
void loop() 
{
    ...
    Serial.print("Yaw: "); Serial.print(yaw);Serial.print(" m/s^2");
    Serial.print("Pitch: "); Serial.print(pitch);Serial.print(" m/s^2");
    Serial.print("Roll: "); Serial.print(roll);Serial.print(" m/s^2");
...
//      computeDistance(a.acceleration.x,dt/1000000.0,angleY);
